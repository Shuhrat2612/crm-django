...
class CustomerDeleteView(LoginRequiredMixin, DeleteView):
    model = Customer
    template_name = 'home/customer_confirm_delete.html'
    success_url = reverse_lazy('customer-list')
...
class LeadDeleteView(LoginRequiredMixin, DeleteView):
    model = Lead
    template_name = 'home/lead_confirm_delete.html'
    success_url = reverse_lazy('leads-list')
...
class DealDeleteView(LoginRequiredMixin, DeleteView):
    model = Deal
    template_name = 'home/deal_confirm_delete.html'
    success_url = reverse_lazy('deals-list')

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Delete Deal'
        return context
...
class TaskUpdateView(UpdateView):
    model = Task
    form_class = TaskForm  # agar ishlatsangiz
    template_name = 'home/tasks_form.html'
    success_url = reverse_lazy('tasks-list')

class TaskDeleteView(DeleteView):
    model = Task
    template_name = 'home/task_confirm_delete.html'  # yoki kerakli template
    success_url = reverse_lazy('tasks-list')
